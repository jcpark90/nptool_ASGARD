...
const double EGATE_MIN = 1360;
const double EGATE_MAX = 1460;


void drawSingles(){
  gStyle->SetOptStat(0);
  tsim = new TChain("SimulatedTree"); 
  tsim->Add("idaten_96Pd.root"); // specify input file name here

  TCanvas* cc = new TCanvas("cc", "cc", 1600, 800);
  
  cc->Divide(2,1);
  htfatima = new TH1D("htfatima", "", 600, -50, 29950); // time in ns
