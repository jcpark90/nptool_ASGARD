...
void calib_singles_coinc(){
  ...
  legend->AddEntry(gidaten, "IDATEN (84 ch)mono", "lp");
  legend->AddEntry(gfatima, "FATIMA (36 ch) mono", "lp");
  legend->AddEntry(gkhala, "KHALA (48 ch) mono", "lp");
  ...
  legend->Draw();
  cg->SaveAs("idaten_hpge_152Eu_efficiency_4000keV.png");
  gidaten->GetXaxis()->SetLimits(0, 2000);
  cg->SaveAs("idaten_hpge_152Eu_efficiency_2000keV.png");
  
  gidaten->GetXaxis()->SetLimits(0, 4500);
  cg->cd()->SetLogx(1);
  gidaten->GetYaxis()->SetNdivisions(11, 5, 0);
  gidaten->GetYaxis()->SetRangeUser(0, 0.21);
  cg->SaveAs("idaten_hpge_152Eu_efficiency_logx.png");
