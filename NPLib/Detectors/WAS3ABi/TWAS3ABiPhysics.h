#ifndef TWAS3ABIPHYSICS_H
#define TWAS3ABIPHYSICS_H
/*****************************************************************************
...
#include "TRandom3.h"
// Forward declaration
class TWAS3ABiSpectra;


using namespace std ;

class TWAS3ABiPhysics : public TObject, public NPL::VDetector{
  public:
    TWAS3ABiPhysics();
    ~TWAS3ABiPhysics() {};
  ...
  public:      //   Specific to WAS3ABi Array
    ...
    // Give and external TMustData object to TWAS3ABiPhysics. Needed for online analysis for example.
    void SetRawDataPointer(TWAS3ABiData* rawDataPointer) {m_EventData = rawDataPointer;}
    // Retrieve raw and pre-treated data
    TWAS3ABiData* GetRawData()        const {return m_EventData;}
    TWAS3ABiData* GetPreTreatedData() const {return m_PreTreatedData;}
  ...
  private:   //   Root Input and Output tree classes
    ...
    TWAS3ABiData*         m_EventData;//!
    TWAS3ABiData*         m_PreTreatedData;//!
    TWAS3ABiPhysics*      m_EventPhysics;//!
  ...
  public: // Static constructor to be passed to the Detector Factory
    ...
    ClassDef(TWAS3ABiPhysics,1)  // WAS3ABiPhysics structure
};
...
namespace WAS3ABi_LOCAL
{
  //   DSSD
  //   Front
  double fStrip_Front_E(const TWAS3ABiData* Data, const int& i);
  double fStrip_Front_T(const TWAS3ABiData* Data, const int& i);

  //   Back   
  double fStrip_Back_E(const TWAS3ABiData* Data, const int& i);
  double fStrip_Back_T(const TWAS3ABiData* Data, const int& i);
