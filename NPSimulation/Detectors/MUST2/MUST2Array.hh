...
namespace MUST2
{
  ...
  const G4double SiLiThickness     = 1.1*mm;  // Must be checked
   const G4double SiLiFaceX         = 48.25*mm;
   const G4double SiLiFaceY         = 92*mm;
   const G4double MylarCsIThickness = 3*micrometer;
  //   const G4double CsIThickness      = 4*cm + 2*MylarCsIThickness ; // MUST2
  const G4double CsIThickness      = 0.3*cm + 2*MylarCsIThickness ; // FAUST
