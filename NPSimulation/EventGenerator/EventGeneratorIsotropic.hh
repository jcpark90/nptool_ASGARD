...
private:    // Source parameter from input file
    ...
    G4double                 m_source_theta     ;  
    G4double                 m_source_phi       ;
    G4String			m_atomic_bgd_file;
    G4double                 m_si_det_thickness    ;  

    G4double                 m_SigmaX           ;
    G4double                 m_SigmaY           ;
    G4double                 m_SigmaR           ;  // sigma R for X/Y in cylindrical coordinates
    G4double                 m_SigmaZ           ;  // sigma Z
  ...
  G4double                 gammasperevent     ;
  G4double extractCS(string str);
  G4double sciToDouble(string& str);
  void SetBackgroundFile(G4String filename, G4double thickness);
};
#endif
