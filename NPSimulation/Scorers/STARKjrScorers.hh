#ifndef STARKjrScorers_h
#define STARKjrScorers_h 1
/*****************************************************************************
 ...
 *---------------------------------------------------------------------------*
 * Decription:                                                               *
 *  File old the scorer specific to the STARKjr Detector                     *
 *                                                                           *
 *---------------------------------------------------------------------------*
 * Comment:                                                                  *
...
namespace STARKjrSCORERS {

  //....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
  class PS_STARKjr_X6: public G4VPrimitiveScorer{

  public: // with description
    PS_STARKjr_X6(G4String name, G4int Level,
  ...
  //....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
  class PS_STARKjr_BB10: public G4VPrimitiveScorer{

  public: // with description
    PS_STARKjr_BB10(G4String name, G4int Level,
  ...
  class PS_STARKjr_QQQ5: public G4VPrimitiveScorer{

  public: // with description
    PS_STARKjr_QQQ5(G4String name, G4int Level,
